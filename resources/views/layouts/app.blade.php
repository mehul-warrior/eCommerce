...
{{--    <link href="https://fonts.bunny.net/css?family=Nunito" rel="stylesheet"> -->--}}
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('MagnificPopup/magnific-popup.css') }}">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{ asset('perfect-scrollbar/perfect-scrollbar.css') }}">
    <!--===============================================================================================-->
...
<!-- Header -->
<header class=" {{Route::currentRouteName() != 'home' ? 'header-v4' : ''}} ">
    <!-- Header desktop -->
